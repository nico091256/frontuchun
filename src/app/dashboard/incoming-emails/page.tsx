      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-slate-900/60 p-6 rounded-2xl border border-slate-800 backdrop-blur-md">
        <div>
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-white tracking-tight">Kiruvchi Email Xatlar</h1>
        ...
        <button
          onClick={handleSync}
          disabled={syncing}
          className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/30 text-amber-400 font-medium text-sm transition-all duration-200 active:scale-95 disabled:opacity-50"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-slate-900/40 p-5 rounded-2xl border border-slate-800 flex items-center gap-4">
          ...
          <div>
            ...
            <div className="text-xs text-amber-400/90 font-medium">Tayinlash kutilmoqda</div>
          </div>
        </div>
        ...
        <div className="bg-slate-900/40 p-5 rounded-2xl border border-slate-800 flex items-center gap-4">
          ...
          <div>
            <div className="text-2xl font-bold text-white">{executionCount}</div>
            <div className="text-xs text-blue-400 font-medium">Ijroga biriktirilgan</div>
          </div>
        </div>
        ...
        <div className="bg-slate-900/40 p-5 rounded-2xl border border-slate-800 flex items-center gap-4">
          ...
          <div>
            ...
            <div className="text-xs text-slate-400 font-medium">Jami qabul qilingan xatlar</div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-slate-900/40 p-4 rounded-2xl border border-slate-800 flex flex-col md:flex-row gap-4 items-center justify-between">
        ...
        <form onSubmit={handleSearchSubmit} className="relative w-full md:w-72">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 text-xs bg-slate-950/60 border border-slate-800 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-amber-500 transition-colors"
          />
        </form>
      </div>

      {/* Main Table / List */}
      <div className="bg-slate-900/40 rounded-2xl border border-slate-800 overflow-hidden backdrop-blur-md">
        {loading ? (
          ...
          <div className="p-12 text-center text-slate-400 flex flex-col items-center gap-3">
            ...
            <p className="text-base font-medium text-slate-300">Hech qanday kiruvchi xat topilmadi</p>
                  ...
                  return (
                    <tr key={doc.id} className="hover:bg-slate-800/30 transition-colors group">
                      <td className="py-3.5 px-4 font-medium text-white max-w-[200px]">
                        <div className="font-semibold text-amber-400 truncate">{doc.senderOrg || "Noma'lum Jo'natuvchi"}</div>
                        <div className="text-[11px] text-slate-500 truncate">{doc.docNumber}</div>
                      </td>

                      <td className="py-3.5 px-4 max-w-[280px]">
                        <div className="font-semibold text-slate-200 line-clamp-1 group-hover:text-white transition-colors">
                          {doc.title}
                        </div>
                      ...
                      <td className="py-3.5 px-4 whitespace-nowrap">
                        {doc.attachments && doc.attachments.length > 0 ? (
                          <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 text-[11px] font-medium">
                            <Paperclip size={12} />
                            {doc.attachments.length} ta fayl
                          </span>
                        ) : (
                          <span className="text-slate-600 text-[11px]">Ilovalarsiz</span>
                        )}
                      </td>

                      <td className="py-3.5 px-4 whitespace-nowrap">
                        {isPending ? (
                          <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-amber-500/10 text-amber-400 border border-amber-500/30 text-[11px] font-semibold">
                            <AlertCircle size={12} />
                            Tayinlash kutilmoqda
                          </span>
                        ) : isExecution ? (
                          <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-blue-500/10 text-blue-400 border border-blue-500/30 text-[11px] font-semibold">
                            <Clock size={12} />
                            Ijroda
                          </span>
                        ) : (
                      ...
                      <td className="py-3.5 px-4 whitespace-nowrap">
                        {doc.executor ? (
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-slate-200 text-xs font-medium">{doc.executor.fullName}</span>
                          </div>
                        ) : (
                      ...
                      <td className="py-3.5 px-4 text-right whitespace-nowrap">
                        <div className="flex items-center justify-end gap-2">
                          ...
                          <button
                            ...
                            className="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg bg-amber-500 hover:bg-amber-600 text-slate-950 font-semibold text-xs shadow-md shadow-amber-500/20 transition-all duration-200 active:scale-95"
                          >
                            <UserCheck size={14} />
        ...
        <div className="flex items-center justify-between px-2 text-xs text-slate-400">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3 py-1.5 rounded-lg bg-slate-800 border border-slate-700 disabled:opacity-40 hover:bg-slate-700 text-white"
            >
              Oldingisi
            </button>
            <span>
          ...
          <div className="bg-slate-900 border border-slate-800 w-full max-w-2xl rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
            <div className="p-5 border-b border-slate-800 flex items-center justify-between bg-slate-950/40">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-white text-base">Kiruvchi Email Tafsilotlari</h3>
                  <p className="text-xs text-slate-400">Raqam: #{selectedDoc.docNumber}</p>
                </div>
              </div>
              <button
            ...
            <div className="p-6 overflow-y-auto space-y-4 text-xs text-slate-300">
              <div className="grid grid-cols-2 gap-4 bg-slate-950/60 p-4 rounded-xl border border-slate-800/80">
                <div>
                  <span className="text-slate-500 font-medium block">Jo'natuvchi Email:</span>
                  <span className="font-semibold text-amber-400">{selectedDoc.senderOrg}</span>
                </div>
                <div>
                  <span className="text-slate-500 font-medium block">Kelgan Vaqti:</span>
              ...
              <div>
                <span className="text-slate-500 font-medium block mb-1">Xat Mavzusi:</span>
                <div className="text-sm font-bold text-white bg-slate-950/40 p-3 rounded-xl border border-slate-800">
                  {selectedDoc.title}
                </div>
              </div>

              <div>
                <span className="text-slate-500 font-medium block mb-1">Xat Matni:</span>
                <div className="bg-slate-950/80 p-4 rounded-xl border border-slate-800 text-slate-200 whitespace-pre-wrap leading-relaxed max-h-60 overflow-y-auto">
                  ...
                  <div className="space-y-2">
                    {selectedDoc.attachments.map((att) => (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="flex items-center justify-between p-3 rounded-xl bg-slate-800/60 hover:bg-slate-800 border border-slate-700/60 transition-colors group"
                      >
                        <div className="flex items-center gap-3">
                        ...
                        <span className="text-[11px] text-slate-400 bg-slate-900 px-2 py-1 rounded-md border border-slate-700">
                          Yuklab olish ↗
                        </span>
                      </a>
                    ))}
          ...
          <div className="bg-slate-900 border border-slate-800 w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden flex flex-col">
            <div className="p-5 border-b border-slate-800 flex items-center justify-between bg-slate-950/40">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-white text-base">Ijroga Yo'naltirish</h3>
                  <p className="text-xs text-slate-400">Hujjat: #{selectedDoc.docNumber}</p>
                </div>
              </div>
              <button
            ...
            <form onSubmit={handleAssignSubmit} className="p-6 space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2.5 text-xs bg-slate-950 border border-slate-800 rounded-xl text-white focus:outline-none focus:border-amber-500"
                >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2.5 text-xs bg-slate-950 border border-slate-800 rounded-xl text-white placeholder-slate-600 focus:outline-none focus:border-amber-500"
                />
              </div>
              ...
              <div className="pt-2 flex items-center justify-end gap-3">
                ...
                <button
                  type="submit"
                  disabled={assigning}
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-amber-500 hover:bg-amber-600 text-slate-950 font-bold text-xs shadow-md shadow-amber-500/20 disabled:opacity-50"
                >
                  <Send size={14} />
